...
@section('title', 'Create Position Intern')

@section('content')

  <div class="page-heading">
  <h3>Create New Intern Position</h3>
  </div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-content">
            <div class="card-body">
              <form class="form" action="{{ route('superadmin_position_intern') }}" data-parsley-validate>
                <div class="row">
                  ...
                  <div class="col-md-6 col-12">
                    <div class="form-group mandatory">
                      <label for="category" class="form-label">Batch</label>
                      <select
                        id="batch"
                        name="batch"
                        class="form-select"
                  ...
                  <div class="col-md-6 col-12">
                    <div class="form-group mandatory">
                      <label for="work-experience" class="form-label">Duration</label>
                ...
                <div class="row">
                  <div class="col-12 d-flex justify-content-end mt-4">
                    ...
                    <a href="{{ route('superadmin_position_intern') }}" class="btn btn-light-secondary me-1 mb-1">
                        Cancel
                    </a>
                  </div>
                </div>
