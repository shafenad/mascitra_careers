    ...
    <div class="card-body">
        ...
        <div class="details-wrapper mt-4">
            ...
            <div class="action-buttons mt-4">
                <a href="{{ route('superadmin_internapplication') }}" class="btn-action btn-back fw-bold">
                    Back
                </a>
...
document.getElementById("linkInterviewModal-confirm").addEventListener("click", function () {
    ...
    window.location.href = "{{ route('superadmin_applicationdetail_interviewsuccess') }}";
});
</script>
...
<script>
    ...
    setTimeout(() => {
        window.location.href = "{{ route('superadmin_applicationdetail_rejected') }}"; 
    }, 300); 
});
</script>
