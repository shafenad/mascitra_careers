            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <p class="mt-3">
                        ...
                        <strong>Interview Stage</strong>. Please review the information carefully and ensure that you are
                        ready to participate in the interview as scheduled. To continue with the interview process,
                        kindly click the link below to access and join your interview session. We recommend checking your
                        availability and preparing any necessary materials in advance.
                    </p>
                ...
                <div class="row mt-2">
                    <div class="col-12 d-flex justify-content-start">
                        <a href="https://us04web.zoom.us/j/77192273590?pwd=RS9CSTAvRVd5SlBoSEVrRlhZSzRsZz09" class="btn btn-primary px-4"> Interview Link </a>
                    </div>
                </div>
