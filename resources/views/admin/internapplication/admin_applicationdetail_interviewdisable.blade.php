    ...
    <div class="card-body">
        ...
        <div class="details-wrapper mt-4">
            ...
            <div class="action-buttons mt-4">
                <a href="{{ route('admin_applicationdetail_interviewsuccess') }}" class="btn-action btn-back fw-bold">
                    Back
                </a>

                <div class="d-flex gap-2">
                    <button class="btn-action btn-interview" disabled>Interview Success</button>
