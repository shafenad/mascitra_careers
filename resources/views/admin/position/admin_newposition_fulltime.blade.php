...
@section('title', 'Create Position Fulltime')

@section('content')

  <div class="page-heading">
  <h3>Create New Fulltime Position</h3>
  </div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-content">
            <div class="card-body">
              <form class="form" action="{{ route('admin_position_fulltime') }}" data-parsley-validate>
                <div class="row">
                ...
                <div class="row">
                  <div class="col-12 d-flex justify-content-end mt-4">
                    ...
                    <a href="{{ route('admin_position_fulltime') }}" class="btn btn-light-secondary me-1 mb-1">
                        Cancel
                    </a>
                  </div>
                </div>
