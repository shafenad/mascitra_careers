...
@section('title', 'Application Detail Accepted')
...
<div class="card">
    <div class="card-body">
        <div class="alert d-flex justify-content-center align-items-center position-relative alert-success alert-dismissible show fade" role="alert" >
        ...
        <div class="details-wrapper mt-4">
            ...
            <div class="action-buttons mt-4">
                <a href="{{ route('superadmin_applicationhistory') }}" class="btn-action btn-back fw-bold">
                    Back
                </a>
            </div>
        ...
        btn.addEventListener('click', function () {
            ...
            switch (label) {
                ...
                case 'internship acceptance letter':
                    fileUrl = 'https://drive.google.com/file/d/1CVwRPT9HYz-WI6NW11T_vjz5oEOGSqdi/preview';
                    break;
                default:
