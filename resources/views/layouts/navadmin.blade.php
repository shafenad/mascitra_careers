    ...
    {{-- Nav --}}
            <header class="mb-4">
                <div class="header-top">
                    <div class="container">
                        <div class="logo">
                            <a href="{{ route('dashboard_admin') }}"><img src="{{ asset('svg/logo_fix.svg') }}" class="logo-mascitra" alt="Logo"></a>
                        </div>
                        <div class="header-top-right">
                            ...
                            <div class="dropdown">
                                <a href="#" id="topbarUserDropdown" class="user-dropdown d-flex align-items-center dropend dropdown-toggle " data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <div class="text">
                                        <h6 class="user-dropdown-name">Septian</h6>
                                ...
                                <li><a class="dropdown-item" href="{{ route('admin_profile') }}">My Account</a></li>
                ...
                <nav class="main-navbar">
                    <div class="container">
                        <ul>
                                ...
                                <div
                                    ...
                                    <div class="submenu-group-wrapper">
                                        ...
                                        <ul class="submenu-group">
                                            ...
                                            <li
                                                class="submenu-item  ">
                                                <a href="{{ route('admin_position_fulltime') }}"
                                            ...
                                            <li
                                                class="submenu-item  ">
                                                <a href="{{ route('admin_position_intern') }}"
                            ...
                            <li
                                class="menu-item">
                                <a href="{{ route('admin_internapplication') }}" class='menu-link'>
                            ...
                            <li
                                class="menu-item">
                                <a href="{{ route('admin_applicationhistory') }}" class='menu-link'>
