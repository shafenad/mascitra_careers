...
@section('title', 'Position Fulltime')
...
<section class="section">
    <div class="card">
        <div class="card-header d-flex justify-content-end">
            <a href="{{ route('admin_newposition_fulltime') }}" class="btn btn-light-primary">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('admin_editposition_fulltime') }}" 
                                    class="action-icon" 
                                    title="Edit">
                                        <i class="bi bi-pencil-fill text-success"></i>
                                </a>
                                <button class="action-icon deactive-btn" data-id="System Analyst" data-bs-toggle="modal" data-bs-target="#deactiveModal">
                                    <i class="bi bi-x-circle-fill text-warning"></i>
                                </button>
                                <button class="action-icon delete-btn" data-id="System Analyst" data-bs-toggle="modal" data-bs-target="#deleteModal">
...
<script>
    ...
    document.getElementById("deleteModal-confirm").addEventListener("click", function () {
        ...
        // ⬇️ REDIRECT
        window.location.href = "{{ route('admin_position_fulltimedelete') }}"; 
    });
</script>
...
<script>
    ...
    document.getElementById("deactiveModal-confirm").addEventListener("click", function () {
        ...
        // ⬇️ REDIRECT
        window.location.href = "{{ route('admin_position_fulltimedeactive') }}";
    });
</script>
